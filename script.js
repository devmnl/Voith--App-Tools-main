    ...
    requestAnimationFrame(() => {
      ...
      const ws_data = [
        [
          ...
          "Peso Seco (g/m²)",
          "Consistência (%)",
          "Peso de Fibras Drenado (g/m²)",
          "Massa Total (g/m²)",
          "Quant. água retirada (g/m²)",
          "Quant. água retirada (l/min)",
          "Porcentual Drenado (%)",
      ...
      console.log(
        ...
        rows.map((row) => {
          ...
          const cells = Array.from(row.querySelectorAll("td input")).map(
